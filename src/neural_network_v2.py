...
from src.utils import (sigmoid, linear, tanh, relu, leaky_relu, elu, swish, mish,
                       ...
                       he_init, xavier_init, mse, mse_derivative, mee)
...
class NeuralNetworkV2:
    ...
    def backward(self, y_true, y_pred):
        ...
        delta = mse_derivative(y_true, y_pred) * self.output_activation_derivative(self.z_outputs[-1])
    ...
    def train(self, X_train, y_train, X_val=None, y_val=None, y_scaler=None,
              ...
              lr_decay=0.0, lr_schedule=None, patience=50, 
              clip_grad=True, max_grad_norm=5.0, verbose=True):
        """
        ...
        for epoch in range(epochs):
            ...
            if lr_schedule is not None and epoch in lr_schedule.get('milestones', []):
            ...
            for start_idx in range(0, num_samples, batch_size):
                ...
                nabla_w, nabla_b, nabla_g, nabla_beta = self.backward(y_batch, y_pred)
